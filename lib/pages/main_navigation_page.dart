...
class _MainNavigationPageState extends State<MainNavigationPage> {
  ...
  // Dynamic build instead of IndexedStack so ReminderPage
  // re-evaluates ReminderStore every time the tab is tapped
  Widget _buildCurrentPage() {
    switch (_currentIndex) {
      case 0:
        return const HomePageContent();
      case 1:
        return const ReminderPage(); // smart: calendar or landing
      case 2:
            ...
            child: Row(
              children: [
                const Icon(Icons.location_on,
                    color: Color(0xFFA2E0FF), size: 18),
